...
{:else}
	<div class="flex flex-col w-full">
		...
		{#if showViewMore}
			...
			<a
				href="/projects"
				class="flex items-center gap-3 p-2 border-b border-dashed border-[var(--notion-border)] hover:bg-[var(--notion-hover)] cursor-pointer transition-colors text-[#9b9a97] hover:text-[var(--notion-text)] focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--notion-bg)] focus-visible:text-[var(--notion-text)] rounded"
			>
