...
export const projects: Project[] = [
	{
		...
		description:
			'The official website for the Student Executive Board of ITS (BEM ITS). Built to serve thousands of students with news, transparency reports, and event information. Features a custom CMS for easy content management and optimized for high traffic.',
		icon: '🏛️',
	...
	},
	{
		...
		description:
			'Official platform for the Society of Renewable Energy ITS Student Chapter. Showcases renewable energy projects, upcoming events, and educational resources. Designed with a clean, eco-friendly aesthetic.',
		icon: '⚡',
	...
	},
	{
		...
		description:
			'An interactive mapping platform designed to visualize environmental data and sustainable initiatives. Users can pin locations, view detailed environmental metrics, and filter by sustainability categories.',
		icon: '🥉️',
		timeline: '2025',
		sources: [
	...
	},
	{
		...
		description:
			'A comprehensive ground control station (GCS) software for autonomous UAVs. Features real-time telemetry tracking, mission planning interface, and safety override protocols. Used in the KRTI national robotics competition.',
		category: ['Achievements', 'Apps'],
		gallery: ['/projects/achievements/bayu1.jpg', '/projects/achievements/bayu2.jpg'],
		featured: true
	},
	{
		...
		timeline: 'Nov 2021',
		description:
			'A Multi Purpose Discord Bot (Entertainment, Utility, etc). Features fun fact, meme generator, mini games, and more.',
		image: '/projects/abangjagobo.png',
		sources: [{ label: 'Source Code', url: 'https://github.com/dimasandhk/abang-jago-bot' }],
		category: ['Bots'],
		featured: true,
		gallery: [
	...
	},
	{
		...
		timeline: 'Mar 2025',
		description:
			'A Discord bot that provides information about free epic games. Features game search, game details, and more.',
		image: '/projects/epicgamesbot.jpg',
		sources: [{ label: 'Source Code', url: 'https://github.com/dimasandhk/free-epic-games' }],
		category: ['Bots']
	},
	{
		...
		timeline: 'May 2021',
		description:
			'A scraper that scrapes the prayer room data from the website and serves it as an API.',
	...
	},
	{
		...
		description:
			'Won 2nd place in the Smart City division for developing an innovative flood control system integration for Jakarta. ARJUNA (Adaptive Real-time Joint-response Urban flood Navigation & Alleviation): Sistem Kendali Banjir Prediktif Berbasis AI dan Digital Twin untuk Kota Jakarta',
		...
		gallery: ['/projects/achievements/gemastik1.webp', '/projects/achievements/gemastik2.webp'],
		category: ['Achievements', 'Apps'],
		featured: true
	},
	{
	...
	},
	{
		...
		description:
			'INI LHO ITS! is the flagship integrated event of Institut Teknologi Sepuluh Nopember (ITS). Its mission is to introduce the university ecosystem—including its faculties, majors, and campus culture—to high school students throughout Indonesia and the world. The platform serves as a bridge, helping students discover their dream majors through interactive content and massive online tryouts.',
