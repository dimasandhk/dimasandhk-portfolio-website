...
export const defaultSEO: SEOConfig = {
	...
	description:
		'Passionate Software Engineer specializing in full-stack development with React, Node.js, Python, and modern web technologies. Award-winning developer from Institut Teknologi Sepuluh Nopember Surabaya.',
	keywords: [
...
export const pageSEO = {
	home: {
		title: 'Dimas Andhika Diputra - Software Engineer',
		description:
			'Passionate Software Engineer specializing in full-stack development. Award-winning developer with achievements in GEMASTIK XVIII and KRTI. Open for internship and freelance opportunities.',
		keywords: [
	...
	projects: {
		...
		description:
			'Explore my portfolio of web applications, bots, and innovative solutions. From award-winning smart city projects to full-stack web applications built with modern technologies.',
		keywords: [
	...
	linktree: {
		...
		description:
			'Connect with me on LinkedIn, GitHub, Instagram, or send me an email. Find all my social media profiles and contact information in one place.',
		keywords: ['Contact', 'Social Media', 'LinkedIn', 'GitHub', 'Developer Links'],
		type: 'website'
	}
};
