<script lang="ts">
	...
	// ⚡ Bolt: Cache Intl.DateTimeFormat outside the render loop
	// Re-instantiating Intl.DateTimeFormat or calling toLocaleDateString inside
	// an #each loop has significant performance penalty.
