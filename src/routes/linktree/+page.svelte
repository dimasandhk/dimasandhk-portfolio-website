					...
					>
						...
						<div class="p-3">
							<a
								...
								class="font-medium text-[var(--notion-text)] hover:underline line-clamp-2 rounded focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--notion-bg)]"
							>
								{video.snippet.title}
							</a>
